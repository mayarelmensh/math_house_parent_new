...
String imageData;
if (image == 'wallet' || paymentMethodId == '10') {
imageData = 'wallet';
} else {
if (image.startsWith('data:image/')) {
imageData = image;
...
print('BuyChapters Request: $body');
print('Headers: {Authorization: Bearer $token}');
...
print('BuyChapters Raw Response: $response');
print('Response Data Type: ${response.data.runtimeType}');
print('Response Data: ${response.data}');
...
String errorMessage = 'Failed to purchase chapters';
